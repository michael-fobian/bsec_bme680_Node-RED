...
#define DESTZONE "TZ=Europe/Copehagen"
                  ...
                  float co2_equivalent, float breath_voc_equivalent)
{
  ...
  printf(",\"gas\": \"%.0f\"", gas / 1000);
  printf(",\"status\": \"%d\"", bsec_status);
  printf(",\"static_iaq\": \"%.0f\"", static_iaq);
  printf(",\"co2_equivalent\": \"%.0f\"", co2_equivalent);
  printf(",\"breath_voc_equivalent\": \"%.0f\"}", breath_voc_equivalent);
